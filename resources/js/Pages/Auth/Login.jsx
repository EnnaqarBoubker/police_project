...
export default function Login({ status, canResetPassword }) {
    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-slate-900">{t('تسجيل الدخول')}</h1>
                <p className="mt-1 text-sm text-slate-500">{t('أدخل بياناتك للوصول إلى مساحة العمل الخاصة بك.')}</p>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
                <div>
                    <InputLabel htmlFor="username" value={t('اسم المستخدم')} />
                ...
                <div className="flex items-center justify-between">
                    <label className="flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-slate-600">{t('تذكرني')}</span>
                    </label>
